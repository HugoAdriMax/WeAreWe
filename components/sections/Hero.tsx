...
export function Hero() {
  return (
    <section className="relative min-h-[85vh] flex items-start bg-gradient-to-b from-primary to-[#1a3731] overflow-hidden pt-8">
      {/* Cercles décoratifs */}
...
{/* Scroll indicator avec espacement vertical augmenté */}
<div className="absolute bottom-4 md:bottom-12 w-full flex justify-center mt-64 md:mt-0">
  <motion.div
    animate={{ y: [0, 10, 0] }}
